								...
								<? foreach ($tarefas as $indice => $tarefa) { ?>
									...
									<div class="row mb-3 d-flex align-items-center tarefa">
										...
										<div class="col-sm-3 mt-2 d-flex justify-content-between">
											<a href="#"><i id="trash_<?= $tarefa->id ?>" class="fas fa-trash-alt fa-lg text-danger" onmouseout="desanima(<?= $tarefa->id ?>)" onmouseover="anima(<?= $tarefa->id ?>)" onclick="remover(<?= $tarefa->id ?>)"></i></a>
